    ...
    <div class="mb-6 flex items-center justify-between border-b border-gray-200 pb-4">
        <div>
            <h2 class="font-bold text-black">
                ...
                <span x-show="mode === 'belajar'">Review Soal #<span x-text="currentIndex + 1"></span></span>
            </h2>
            <p class="text-sm text-gray-500"
                x-text="mode === 'tryout' ? 'Silahkan jawab pertanyaan di bawah' : 'Lihat pembahasan dan jawabanmu'"></p>
        </div>
                    ...
                    <div @click="mode === 'tryout' ? selectAnswer(optionKey, optionData.id) : null"
                        ...
                        :class="{
                            ...
                            'bg-red-300 border-red-500 text-white': mode === 'belajar' && answers[currentQuestion
                                ...
                                .correctAnswer !==
                                optionKey,
                            'border-main-bg bg-main-bg/40 text-white': mode === 'belajar' && currentQuestion
                                .correctAnswer === optionKey,
                            'border-main-bg bg-main-bg/50 text-white': mode === 'tryout' && answers[
                        ...
                        <div class="flex items-center gap-4">
                            <div class="border-ujian-gray-200 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-md border bg-white text-sm font-bold text-black"
                                :class="{
                                    '!border-main-bg !bg-main-bg text-white': mode === 'belajar' && currentQuestion
                                        .correctAnswer === optionKey,
        ...
        <template x-if="currentQuestion && currentQuestion.type === 'isian'">
            <div>
                ...
                <textarea id="jawaban_isian" rows="4"
                    ...
                    :disabled="mode === 'belajar'"
                    @input.debounce.500ms="mode === 'tryout' ? selectAnswer(null, null, $event.target.value) : null"></textarea>
            </div>
        </template>
    </div>
