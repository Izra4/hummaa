{{-- Komponen Modal yang dikontrol oleh Alpine.js --}}
    ...
    <div class="relative w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
        ...
        <div class="mt-6 flex justify-end space-x-3">
            <button @click="isModalOpen = false" type="button"
                class="rounded-lg border border-gray-300 bg-white px-6 py-2 font-semibold text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                Kembali
            </button>
            <button @click="submitExam()" {{-- Memanggil fungsi untuk submit --}} type="button"
                class="bg-ujian-blue focus:ring-ujian-blue rounded-lg px-6 py-2 font-semibold text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2">
                Kumpulkan
            </button>
        </div>
    </div>
